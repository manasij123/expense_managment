...
object Prefs {
    ...
    private const val KEY_GAS_HOUR = "gas_alarm_hour"
    private const val KEY_GAS_MINUTE = "gas_alarm_minute"
    ...
    // Matches the server-side gas_cylinder_reminder Cloud Scheduler's default time.
    private const val DEFAULT_GAS_HOUR = 10
    private const val DEFAULT_GAS_MINUTE = 0
    ...
    fun getGasAlarmHour(context: Context): Int = prefs(context).getInt(KEY_GAS_HOUR, DEFAULT_GAS_HOUR)
    fun setGasAlarmHour(context: Context, value: Int) {
        prefs(context).edit().putInt(KEY_GAS_HOUR, value).apply()
    }

    fun getGasAlarmMinute(context: Context): Int = prefs(context).getInt(KEY_GAS_MINUTE, DEFAULT_GAS_MINUTE)
    fun setGasAlarmMinute(context: Context, value: Int) {
        prefs(context).edit().putInt(KEY_GAS_MINUTE, value).apply()
    }
